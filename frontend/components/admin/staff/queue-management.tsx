    ...
    <div className="flex flex-col gap-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          View and manage queues for each location (Houston, Pasadena, Sugar Land).
        </p>
      </div>

      {/* LOCATION SELECT */}
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-4">
        <label className="text-sm font-medium" id="service-select-label">
          Select Location
        </label>
          ...
          <CardHeader className="flex flex-row items-start justify-between">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <Button
                ...
                onClick={() =>
                  queue.length > 0 &&
                  setQueueEntryStatus(queue[0].id, "almost-ready")
                }
            ...
            {queue.length === 0 ? (
              ...
              <div className="flex flex-col items-center gap-3 py-8 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  No one is currently in this queue.
                </p>
              </div>
                      ...
                      <TableRow key={entry.id}>
                        ...
                        <TableCell>
                          ...
                          <Select
                            value={entry.status}
                            onValueChange={(v) =>
                              setQueueEntryStatus(entry.id, v as QueueStatus)
                            }
                          >
                        ...
                        <TableCell>
                          <div className="flex items-center justify-end gap-1">
                            ...
                            <Button
                              ...
                              variant="ghost"
                              onClick={() =>
                                reorderQueue(selectedServiceId, entry.id, "up")
                              }
                              disabled={idx === 0}
                            >
                            ...
                            <Button
                              ...
                              variant="ghost"
                              onClick={() =>
                                reorderQueue(selectedServiceId, entry.id, "down")
                              }
